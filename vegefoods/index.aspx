<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DoAnVegeFoody.vegefoods.index" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <%--<asp:Repeater ID="Repeater2" runat="server" >
                                <ItemTemplate>
                           <%--         <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/<%#Eval("Type_img")%>);"
                                        <div><image src="images/<%# Eval("Type_img") %>"  class="category-wrap ftco-animate img mb-4 d-flex align-items-end" alt="Colorlib Template">
                                            <div class="text px-3 py-1">
                                    <h2 class="mb-0"><a href="#"><%#Eval("Type_name") %></a></h2>
                                </div>
                                             </image>
                            ...
                            <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-2.jpg);">
                                <div class="text px-3 py-1">
                                    <h2 class="mb-0"><a href="shop.aspx?type=<%#Eval("type") %>">Fruits</a></h2>
                                </div>
                            </div>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="col-md-6 col-lg-3 ftco-animate">
                            <div class="product">
                                ...
                                <asp:HiddenField ID="hf_type" Value='<%#Eval("type") %>' runat="server" />
                                <a href="Product_single.aspx?id=<%#Eval("id") %> " class="img-prod">
                                    ...
                                    <%-- //<img class="img-fluid" src="images/<%Eval("img"); %>" >--%>
