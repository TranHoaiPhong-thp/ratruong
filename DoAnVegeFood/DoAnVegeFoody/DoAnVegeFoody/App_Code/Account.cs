...
namespace DoAnVegeFoody.App_Code
{
    public class Account 
    {
        ...
        {
            String sQuery = "UPDATE [dbo].[member] SET [username] = @username,[pass] = @pass,[name] = @name,[phone] = @phone,[status] = @status,[role] = @role,[email] = @email WHERE username = @username";
        ...
        //public bool UpdateMember()
        //{
        //    String sQuery = "UPDATE [dbo].[member]SET [username] = @us,[pass] = @pass,[name] = @name,[phone] = @phone,[status] = @status,[role] = @role,[email] = @email WHERE [username]=@us";
